...
if __name__ == '__main__':
    ...
    df = pd.concat([pca_df, ica_df, kpca_df, dca_df, sfa_df], ignore_index=True, axis=0)
    ...
    plot_htune(kpca_df, 'kPCA', fig_axes=[fig, ax[0, 2], ax[1, 2]],
               yaxlabel=False, save=False)
    ...
    # Add A, B, C, D, E, F, G, H, I, J labels to subplots
